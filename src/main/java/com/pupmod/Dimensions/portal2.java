...
public class portal2 extends BlockBreakable
{
     ...
     */
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity entityin){
        if (entityin.ridingEntity == null && entityin.riddenByEntity == null && entityin instanceof EntityPlayerMP){
        	EntityPlayerMP player = (EntityPlayerMP) entityin;
        	if(player.timeUntilPortal > 0)	{
        		player.timeUntilPortal = 11;
        	}else if (player.dimension == 0){
        		player.timeUntilPortal = 11;
        		player.mcServer.getConfigurationManager().transferPlayerToDimension(player,pupmod.dimensionid2, new DimensionTeleporter2(player.mcServer.worldServerForDimension(pupmod.dimensionid2)));
        	}else if (player.dimension == pupmod.dimensionid2)	{
        		player.timeUntilPortal = 11;
        		player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new DimensionTeleporter2(player.mcServer.worldServerForDimension(0)));
        	}
        }
    }
    ...
    {
        portal2.Size size = new portal2.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
        portal2.Size size1 = new portal2.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        portal2.Size size = new portal2.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        portal2.Size size1 = new portal2.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
    ...
    public void randomDisplayTick(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        ...
        for (int l = 0; l < 4; ++l)
        {
            ...
            d3 = ((double)p_149734_5_.nextFloat() - 5.5D) * 5.5D;
            d4 = ((double)p_149734_5_.nextFloat() - 5.5D) * 5.5D;
            d5 = ((double)p_149734_5_.nextFloat() - 5.5D) * 5.5D;
            ...
            {
                d0 = (double)p_149734_2_ + 5.5D + 5.25D * (double)i1;
                d3 = (double)(p_149734_5_.nextFloat() * 2.0F * (float)i1);
            }
            else
            {
                d2 = (double)p_149734_4_ + 5.5D + 5.25D * (double)i1;
    ...
    public static class Size
        {
            ...
            public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                ...
                this.field_150863_d = portal2.field_150001_a[p_i45415_5_][0];
                this.field_150866_c = portal2.field_150001_a[p_i45415_5_][1];
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[portal2.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[portal2.field_150001_a[this.field_150865_b][1]];
                        ...
                        if (j == 0)
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[portal2.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[portal2.field_150001_a[this.field_150865_b][0]]);
                        ...
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[portal2.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[portal2.field_150001_a[this.field_150865_b][1]]);
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[portal2.field_150001_a[this.field_150865_b][1]];
                    k = this.field_150861_f.posY + this.field_150862_g;
                    l = this.field_150861_f.posZ + i * Direction.offsetZ[portal2.field_150001_a[this.field_150865_b][1]];

                    if (this.field_150867_a.getBlock(j, k, l) != pupmod.b)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == pupmod.a|| p_150857_1_ == pupmod.portal2;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    for (int l = 0; l < this.field_150862_g; ++l)
                    {
                        ...
                        this.field_150867_a.setBlock(j, i1, k, pupmod.portal2, this.field_150865_b, 2);
                    }
                }
            }
        }
