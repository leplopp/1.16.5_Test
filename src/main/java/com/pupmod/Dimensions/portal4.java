...
public class portal4 extends BlockBreakable
{
    ...
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity entityin){
        if (entityin.ridingEntity == null && entityin.riddenByEntity == null && entityin instanceof EntityPlayerMP){
        	...
        	if(player.timeUntilPortal > 0)	{
        		player.timeUntilPortal = 13;
        	}else if (player.dimension == 0){
        		player.timeUntilPortal = 13;
        		player.mcServer.getConfigurationManager().transferPlayerToDimension(player,pupmod.dimensionid4, new DimensionTeleporter4(player.mcServer.worldServerForDimension(pupmod.dimensionid4)));
        	}else if (player.dimension == pupmod.dimensionid4)	{
        		player.timeUntilPortal = 13;
        		player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 0, new DimensionTeleporter4(player.mcServer.worldServerForDimension(0)));
        	}
        }
    }
    ...
    {
        portal4.Size size = new portal4.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 1);
        portal4.Size size1 = new portal4.Size(p_150000_1_, p_150000_2_, p_150000_3_, p_150000_4_, 2);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        portal4.Size size = new portal4.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 1);
        portal4.Size size1 = new portal4.Size(p_149695_1_, p_149695_2_, p_149695_3_, p_149695_4_, 2);
    ...
    public static class Size
        {
            ...
            public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                ...
                this.field_150863_d = portal4.field_150001_a[p_i45415_5_][0];
                this.field_150866_c = portal4.field_150001_a[p_i45415_5_][1];
            ...
            protected int func_150858_a()
            {
                ...
                for (this.field_150862_g = 0; this.field_150862_g < 21; ++this.field_150862_g)
                {
                    ...
                    {
                        k = this.field_150861_f.posX + j * Direction.offsetX[portal4.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.posZ + j * Direction.offsetZ[portal4.field_150001_a[this.field_150865_b][1]];
                        ...
                        if (j == 0)
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[portal4.field_150001_a[this.field_150865_b][0]], i, l + Direction.offsetZ[portal4.field_150001_a[this.field_150865_b][0]]);
                        ...
                        {
                            block = this.field_150867_a.getBlock(k + Direction.offsetX[portal4.field_150001_a[this.field_150865_b][1]], i, l + Direction.offsetZ[portal4.field_150001_a[this.field_150865_b][1]]);
                ...
                {
                    j = this.field_150861_f.posX + i * Direction.offsetX[portal4.field_150001_a[this.field_150865_b][1]];
                    k = this.field_150861_f.posY + this.field_150862_g;
                    l = this.field_150861_f.posZ + i * Direction.offsetZ[portal4.field_150001_a[this.field_150865_b][1]];

                    if (this.field_150867_a.getBlock(j, k, l) != pupmod.c)
                    {
            ...
            {
                return p_150857_1_.getMaterial() == Material.air || p_150857_1_ == pupmod.b|| p_150857_1_ == pupmod.portal4;
            }
            ...
            public void func_150859_c()
            {
                for (int i = 0; i < this.field_150868_h; ++i)
                {
                    ...
                    for (int l = 0; l < this.field_150862_g; ++l)
                    {
                        ...
                        this.field_150867_a.setBlock(j, i1, k, pupmod.portal4, this.field_150865_b, 2);
                    }
                }
            }
        }
