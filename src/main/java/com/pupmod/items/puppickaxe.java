...
public class puppickaxe extends ToolItem {
	...
	public puppickaxe(float g, float f, IItemTier item, Properties prob) {
		super(g, f, item, DIGGABLES, prob.addToolType(ToolType.PICKAXE, item.getLevel()));
	}
