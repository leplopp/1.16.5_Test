...
public class registerblocks {
	...
	public static final RegistryObject<Block> KIRCHNER_BLOCK = BLOCKS.register("kirchner_block",
			() -> new invisibleblock(BlockBehaviour.Properties.of(Material.STONE).harvestLevel(3)
	...
	public static final RegistryObject<Block> SCHMUMLER_BLOCK = BLOCKS.register("schmumler_block",
			() -> new BarrierBlock(BlockBehaviour.Properties.of(Material.STONE).harvestLevel(3)
	...
	public static final RegistryObject<Block> SNOT_BLOCK = BLOCKS.register("snot_block",
			() -> new snot_block(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_LIGHT_GREEN).harvestLevel(0)
	...
	public static final RegistryObject<Block> PUKE_BLOCK = BLOCKS.register("puke_block",
			() -> new Block(BlockBehaviour.Properties.of(Material.EGG, MaterialColor.COLOR_GREEN).harvestLevel(0)
	...
	public static final RegistryObject<Block> PINK_CLAY_BLOCK = BLOCKS.register("pink_teracotta",
			() -> new Block(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_PINK).harvestLevel(1)
	...
	public static final RegistryObject<Block> BLOOD_BLOCK = BLOCKS.register("blood_block",
			() -> new Block(BlockBehaviour.Properties.of(Material.GRASS, MaterialColor.COLOR_RED).harvestLevel(0)
					.strength(0f, 10).sound(SoundType.ROOTS)));
	
	public static final RegistryObject<Block> PINK_BRICKS = BLOCKS.register("pink_bricks",
			() -> new block_pink_bricks(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_PURPLE).harvestLevel(2)
	...
	public static final RegistryObject<Block> PINK_SAND = BLOCKS.register("pink_sand",
			() -> new Block(BlockBehaviour.Properties.of(Material.SAND, MaterialColor.TERRACOTTA_PINK).harvestLevel(0)
	...
	public static final RegistryObject<Block> STONE_LADDER = BLOCKS.register("ledder_stone",
			() -> new pupLadderBlock(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_PINK).harvestLevel(1)
