...
public interface IFluidLoggable extends IWaterLoggable {
	default boolean canPlaceLiquid(IBlockReader p_204510_1_, BlockPos p_204510_2_, BlockState p_204510_3_, Fluid p_204510_4_) {
	      return !p_204510_3_.getValue(BlockStateProperties.WATERLOGGED) && p_204510_4_ == liquid.pink_fluid;
	   }

	   default boolean placeLiquid(IWorld p_204509_1_, BlockPos p_204509_2_, BlockState p_204509_3_, FluidState p_204509_4_) {
	      if (!p_204509_3_.getValue(BlockStateProperties.WATERLOGGED) && p_204509_4_.getType() == liquid.pink_fluid) {
